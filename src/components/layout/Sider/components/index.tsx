      ...
      {/* <div className={`${loading ? "hidden" : "block"}`}> */}
        ...
        >
          {props._url === "/home" && props._url === props.pathname ? (
            ...
            >
              <Image src={props._clickedIcon} height={0} width={0} alt="" className="w-[20px] h-auto" />
            </div>
          ) : props._url !== "/home" && props.pathname.includes(props._url) ? (
            <div
              className={`${
            ...
            >
              <Image src={props._icon} height={0} width={0} alt="" className="w-[18px] h-auto" />
            </div>
          )}
              ...
              {props._url === "/home" && props._url === props.pathname ? (
                <>
                  <div className="absolute right-[20px] w-[8px]">
                    <Image src="/icon/active.svg" height={0}  width={0} alt="" className="w-[8px] h-auto"/>
                  </div>
                </>
              ) : props._url !== "/home" &&
                props.pathname.includes(props._url) ? (
                <div className="absolute right-[20px] w-[8px]">
                  <Image src="/icon/active.svg" height={0} width={0} className="w-[8px] h-auto" alt="" />
                </div>
              ) : (
                <></>
              )}
